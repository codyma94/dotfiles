...
// Access to the routing table protected by a mutex.
...
// Creates and returns a new routing table,
// placing the local node at the appropriate slot in each level of the table.
