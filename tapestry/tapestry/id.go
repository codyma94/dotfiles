...
//  The node with the shorter RTT is closer.
//
// In this implementation, we have decided to define closeness as the absolute value of the difference between a and b.
// This is NOT the same asyour implementation of BetterChoice.
//
